      ...
      >
        <div className="card">
          ...
          <div
            ...
            style={{ maxHeight: "600px", overflowY: "auto", padding: 0 }}
          >
            <table
              style={{
                width: "100%",
                  ...
                  <tr key={member.id}>
                    ...
                    >
                      {member.salaryType === "hourly"
                        ? `₹${member.hourlyRate || 150}/hr`
                        : `₹${member.baseSalary || 0}/mo`}
                    </td>
                    <td>
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setNewMember({ ...newMember, specialties: e.target.value })
                  }
              ...
              >
                ...
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewMember({ ...newMember, salaryType: e.target.value })
                    }
                    style={{ cursor: "pointer" }}
                  >
                  ...
                  <div style={{ marginBottom: "1rem" }}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewMember({
                          ...newMember,
                          hourlyRate: parseFloat(e.target.value) || 150,
                        })
                      }
                      placeholder="150"
                      min="50"
                    ...
                    >
                      Standard: 8 hrs/day, Overtime: 1.5x rate
                    </div>
                  </div>
                ) : (
                  <div style={{ marginBottom: "1rem" }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewMember({
                        ...newMember,
                        bonusPercentage: parseFloat(e.target.value) || 5,
                      })
                    }
                    placeholder="5"
                    min="0"
