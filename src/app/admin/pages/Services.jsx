...
import {
  exportServicesAsPDF,
  exportServicesAsExcel,
} from "../pages/exportUtils";
...
const Services = () => {
  ...
  useEffect(() => {
    ...
    if (selectedCategoryFilter !== "All") {
      filtered = filtered.filter(
        (service) => service.category === selectedCategoryFilter,
      );
    }
  ...
  const handleDeleteCategory = async (categoryId, categoryName) => {
    ...
    if (servicesUsingCategory.length > 0) {
      if (
        !window.confirm(
          `${servicesUsingCategory.length} service(s) are using this category. They will be set to "Other". Continue?`,
        )
      ) {
        return;
      }
      ...
      >
        ...
        <div style={{ display: "flex", gap: "0.5rem", marginLeft: "auto" }}>
          <button
            ...
            disabled={
              filteredServices.length === 0 || exportingPDF || exportingExcel
            }
            style={{
              display: "flex",
              alignItems: "center",
            ...
            categoryGroups.map((categoryName) => (
              <div key={categoryName} className="card">
                ...
                <div className="card-content" style={{ padding: "0" }}>
                  <div className="card-grid-lg" style={{ padding: "1rem" }}>
                    ...
                    >
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: "0.375rem",
                          cursor:
                            newCategoryName.trim() && !categoryLoading
                              ? "pointer"
                              : "not-allowed",
                          fontSize: "0.75rem",
                          fontWeight: "500",
