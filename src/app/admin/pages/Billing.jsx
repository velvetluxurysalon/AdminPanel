          ...
          <div className="grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setBillDetails({ ...billDetails, customer: e.target.value })
                }
                placeholder="Name"
              />
            </div>
            ...
            >
              {[
                ...
                <button
                  key={mode.label}
                  onClick={() =>
                    setBillDetails({ ...billDetails, paymentMode: mode.label })
                  }
            ...
            <div style={{ display: "flex", gap: "0.25rem" }}>
              {[1, 2, 3, 4, 5].map((star) => (
                <Star
                  ...
                  size={20}
                  fill={
                    billDetails.feedbackRating >= star
                      ? "var(--primary)"
                      : "none"
                  }
                  color={
                  ...
                  onClick={() =>
                    setBillDetails({ ...billDetails, feedbackRating: star })
                  }
