...
import { ShoppingCart, Scissors, Plus, Check, X, DollarSign, ChevronDown, Phone, Eye, Trash2 } from 'lucide-react';
                    ...
                    <td style={{ padding: '1.25rem 1.5rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        <div style={{
                          ...
                          {((visit.customer?.name || visit.customerName || visit.name || 'C')).charAt(0).toUpperCase()}
                        </div>
                        <div>
                          <div style={{ fontWeight: '600', color: '#1f2937' }}>
                            {visit.customer?.name || visit.customerName || visit.name || 'Unknown'}
                          </div>
                    ...
                    <td style={{ padding: '1.25rem 1.5rem' }}>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#1f2937' }}>
                          <Phone size={14} /> {visit.customer?.phone || visit.customer?.contactNo || visit.customerPhone || visit.phone || 'N/A'}
                        </div>
                        {(visit.customer?.email || visit.customerEmail) && (
                          <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>{visit.customer?.email || visit.customerEmail}</div>
                        )}
                      </div>
                    </td>
                    <td style={{ padding: '1.25rem 1.5rem' }}>
