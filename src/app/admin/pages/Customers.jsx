                                ...
                                <tr key={customer.id} onClick={() => setSelectedCustomer(customer)} style={{ cursor: 'pointer' }}>
                                    ...
                                    <td>
                                        <span style={{
                                            ...
                                            borderRadius: '999px',
                                            fontSize: '0.75rem',
                                            backgroundColor: customer.membershipType === 'elite' ? 'rgba(251, 146, 60, 0.1)' : customer.membershipType === 'membership' ? 'rgba(139, 92, 246, 0.1)' : 'rgba(107, 114, 128, 0.1)',
                                            color: customer.membershipType === 'elite' ? '#fb923c' : customer.membershipType === 'membership' ? '#8b5cf6' : '#6b7280',
                                            border: `1px solid ${customer.membershipType === 'elite' ? 'rgba(251, 146, 60, 0.2)' : customer.membershipType === 'membership' ? 'rgba(139, 92, 246, 0.2)' : 'rgba(107, 114, 128, 0.2)'}`
                                        }}>
                                            {customer.membershipType === 'elite' ? '👑 Elite' : customer.membershipType === 'membership' ? '⭐ Member' : 'Regular'}
                                        </span>
                                    </td>
                        ...
                        <div className="card-content">
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                                <div style={{ padding: '1rem', background: 'var(--secondary)', borderRadius: 'var(--radius)', textAlign: 'center' }}>
                                    <div style={{ fontSize: '0.75rem', color: 'var(--muted-foreground)', marginBottom: '0.5rem' }}>Membership</div>
                                    <div style={{ fontSize: '1.25rem', fontWeight: '700', color: selectedCustomer.membershipType === 'elite' ? '#fb923c' : selectedCustomer.membershipType === 'membership' ? '#8b5cf6' : '#6b7280' }}>
                                        {selectedCustomer.membershipType === 'elite' ? '👑 Elite' : selectedCustomer.membershipType === 'membership' ? '⭐ Member' : 'Regular'}
                                    </div>
                                </div>
                                <div style={{ padding: '1rem', background: 'var(--secondary)', borderRadius: 'var(--radius)', textAlign: 'center' }}>
                    ...
                    <div className="card" style={{ width: '500px' }}>
                        ...
                        <div className="card-content">
                            ...
                            <div style={{ marginBottom: '1.5rem' }}>
                                <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem', fontWeight: '500' }}>Membership Type</label>
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.75rem' }}>
                                    <button
                                        onClick={() => setEditFormData({ ...editFormData, membershipType: 'regular' })}
                                        style={{
                                            padding: '0.75rem',
                                            background: editFormData.membershipType === 'regular' ? '#6b7280' : '#f3f4f6',
                                            color: editFormData.membershipType === 'regular' ? 'white' : '#374151',
                                            border: 'none',
                                    ...
                                    <button
                                        onClick={() => setEditFormData({ ...editFormData, membershipType: 'membership' })}
                                        style={{
                                            padding: '0.75rem',
                                            background: editFormData.membershipType === 'membership' ? '#8b5cf6' : '#f3f4f6',
                                            color: editFormData.membershipType === 'membership' ? 'white' : '#374151',
                                            border: 'none',
                                            borderRadius: 'var(--radius)',
                                            cursor: 'pointer',
                                            fontWeight: '600',
                                    ...
                                    <button
                                        onClick={() => setEditFormData({ ...editFormData, membershipType: 'elite' })}
                                        style={{
                                            padding: '0.75rem',
                                            background: editFormData.membershipType === 'elite' ? '#fb923c' : '#f3f4f6',
                                            color: editFormData.membershipType === 'elite' ? 'white' : '#374151',
                                            border: 'none',
                                            borderRadius: 'var(--radius)',
                                            cursor: 'pointer',
                                            fontWeight: '600',
