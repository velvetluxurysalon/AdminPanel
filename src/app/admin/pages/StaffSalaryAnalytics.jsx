    ...
    try {
      ...
      records.forEach((record) => {
        ...
        if (record.workHours) {
          ...
          const punchIn =
            record.punchInTime && record.punchInTime.toDate
              ? record.punchInTime.toDate()
              : new Date(record.punchInTime);
          const punchOut =
            record.punchOutTime && record.punchOutTime.toDate
      ...
      if (staffMember.salaryType === "hourly") {
        basePay =
          Math.min(totalHours, standardHours) * (staffMember.hourlyRate || 0);
      ...
      const attendancePercentage =
        workDays + absentDays > 0
          ? (presentDays / (workDays + absentDays)) * 100
          : 0;
      let bonusAmount = 0;
      ...
      for (const staffMember of staff) {
        ...
        const bonusAmount =
          attendancePercentage >= 95
            ? basePay * ((staffMember.bonusPercentage || 0) / 100)
            : 0;
        let deductions = 0;
        if (absentDays > 2) {
          deductions = (absentDays - 2) * (staffMember.hourlyRate || 0) * 8;
      ...
      >
        <button
          ...
          style={{
            padding: "0.5rem 1rem",
            background:
              viewMode === "detail" ? "var(--primary)" : "var(--secondary)",
        ...
        <button
          ...
          style={{
            padding: "0.5rem 1rem",
            background:
              viewMode === "overview" ? "var(--primary)" : "var(--secondary)",
          ...
          {salaryData && (
            <div>
                  ...
                  <div className="card-content">
                    ...
                    >
                      <div>
                        ...
                        >
                          {salaryData.attendancePercentage}%
                        </div>
                      </div>
                  ...
                  <div className="card-content">
                    ...
                    >
                      <div>
                        ...
                        {salaryData.standardHours}
                      </div>
                      <div>
                        <span style={{ color: "#f59e0b" }}>Overtime:</span>{" "}
                  ...
                  <div className="card-content">
                    ...
                    >
                      <div>
                        ...
                        >
                          +{formatCurrency(salaryData.bonusAmount)}
                        </div>
                      </div>
                      <div>
                        <div
              ...
              <div className="card" style={{ marginTop: "1.5rem" }}>
                ...
                <div
                  className="card-content table-wrapper"
                  style={{ padding: 0 }}
                >
                  <table
                    style={{ width: "100%", borderCollapse: "collapse" }}
                    className="salary-breakdown-table"
                  >
                    <tbody>
                      <tr
                        style={{
                      ...
                      >
                        ...
                        >
                          ₹{salaryData.staffMember.hourlyRate}/hr
                        </td>
                      </tr>
                      <tr
                        style={{
                      ...
                      >
                        ...
                        >
                          {salaryData.overtimeHours} hrs @ 1.5x
                        </td>
                      </tr>
                      <tr
                        style={{
      ...
      {viewMode === "overview" && (
        <div className="card">
          ...
          <div
            ...
            style={{ padding: 0, maxHeight: "800px", overflowY: "auto" }}
          >
            <table
              style={{
                width: "100%",
              ...
              className="payroll-overview-table"
            >
              <thead>
                <tr
                  style={{
                  ...
                  >
                    ...
                    <td
                      style={{
                        ...
                        fontWeight: "600",
                        color:
                          salary.attendancePercentage >= 95
                            ? "#10b981"
                            : salary.attendancePercentage >= 80
                              ? "#f59e0b"
                              : "#ef4444",
                      }}
                    >
              ...
              <tfoot>
                ...
                >
                  ...
                  >
                    {formatCurrency(
                      allStaffSalaries.reduce((sum, s) => sum + s.basePay, 0),
                    )}
                  </td>
                  <td
                    style={{
                  ...
                  >
                    {formatCurrency(
                      allStaffSalaries.reduce(
                        (sum, s) => sum + s.overtimePay,
                        0,
                      ),
                    )}
                  </td>
                  ...
                  >
                    {formatCurrency(
                      allStaffSalaries.reduce((sum, s) => sum + s.netPay, 0),
                    )}
                  </td>
                </tr>
              </tfoot>
