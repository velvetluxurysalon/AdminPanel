          ...
          <div className="card-content">
            {!isAddingNew ? (
              <button
                ...
                className="btn btn-primary faq-form-button"
                style={{ width: "100%" }}
              >
              ...
              >
                <div>
                  ...
                  <textarea
                    className="input faq-form-input"
                ...
                <div
                  className="faq-form-button-group"
                ...
                >
                  ...
                  <button
                    ...
                    className="btn btn-secondary faq-form-button"
                    style={{ flex: 1 }}
                  >
                    Cancel
                  </button>
