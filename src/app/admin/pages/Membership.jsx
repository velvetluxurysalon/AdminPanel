...
import { getMemberships, updateMembership, initializeMemberships } from '../utils/firebaseUtils';
...
const MembershipManagement = () => {
  ...
  return (
    <div style={{ padding: '2rem' }}>
      <h1 style={{ marginBottom: '2rem', fontSize: '2rem', fontWeight: 'bold' }}>Membership Management</h1>
            ...
            {editingId === membership.id ? (
              ...
              <div>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, fontSize: '1.1rem', fontWeight: '600', color: '#667eea' }}>
                    {membership.discountPercentage}% Discount
                  </p>
                </div>

                <div>
                  <h4 style={{ margin: '0 0 0.75rem', fontWeight: '600' }}>Benefits:</h4>
                  <ul style={{
                    margin: 0,
                    paddingLeft: '1.5rem',
                    display: 'flex',
                    ...
                    {membership.benefits?.map((benefit, index) => (
                      <li key={index} style={{ color: '#333', fontSize: '0.95rem' }}>
                        {benefit}
                      </li>
                    ))}
                  </ul>
